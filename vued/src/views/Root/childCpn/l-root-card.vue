...
<script>
// import mDropdown from "../../../components/common/m-dropdown/m-dropdown.vue";
export default {
  components: {},
  name: "LRootCard",
  props: {
